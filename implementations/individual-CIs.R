...
source("Documents/GitHub/PSY2R/functions/t_indiv.R")
...
#get MOE (CC*SE)
moe_indiv.b <- unlist(lapply(se_b, contrast_ci, cc=cc_indiv))
...
cc_indiv.w <- cc_individual(v_e)

#get MOE (CC*SE)
moe_indiv.w <- lapply(se_w, contrast_ci, cc=cc_indiv.w)

# make this pretty
est_w - do.call(cbind, moe_indiv.w)
est_w
est_w + do.call(cbind, moe_indiv.w)
